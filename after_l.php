								...
								<div class="6u$ 12u$(xsmall)">
									...
									<h4>Parking Related Services</h4>
										...
										<ul class="actions vertical">
											...
											<li><button  class="button special fit" onclick="window.location.href='slots.php'">Book Slot</button></li>
		...
		<!-- Scripts -->
			...
			<script>
				...
				function AJAX_BOOM(){
					...
					xhr.open("GET","http://localhost:80/xampp/new/php/response.php",true);
					xhr.send();
					xhr.onload = function(){
						if(xhr.status === 200){
