...
<html>
	...
	<body>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1>Smart Parking :<br> <span>by sakshi, manashree ,priyanka , pranav <br /><br>
		...
		<!-- Three -->
			<section id="three">
				<div class="inner">
					...
					<article>
						<div class="content">
							<span class="icon fa-product-hunt"></span>
							<header>
					...
					<article>
					<div class="content">
							<span class="icon fa-hourglass-start"></span>
							<header>
								<h3>Start Parking</h3>
							</header>
				...
				<div class="inner">
					<article>
						<div class="content">
							...
							<div class="image fit">
								<img src="images/1.jpg" alt="" height="275"/>
							</div>
					...
					<article class="alt">
						<div class="content">
							...
							<div class="image fit">
								<img src="images/H.jpg" alt="" height="275"/>
							</div>
